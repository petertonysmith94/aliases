...
alias kcx='kubectx'
alias kctest="kubectl run --rm -i --tty testpod --image=alpine --restart=Never -- sh"
...
# You may wish to change .zshrc to .bashrc depending on which shell you use
alias fresh="clear && source ~/.profile && source ~/.zshrc"

# Launch VS code
alias vcode="/snap/bin/code"
